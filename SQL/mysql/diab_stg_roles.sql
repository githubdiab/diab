...
CREATE TABLE `roles` (
  ...
  KEY `ix_roles_create_datetime` (`create_datetime`),
  KEY `ix_roles_creator_id` (`creator_id`),
  KEY `ix_roles_is_deleted` (`is_deleted`),
  KEY `ix_roles_update_datetime` (`update_datetime`),
  KEY `ix_roles_updater_id` (`updater_id`)
